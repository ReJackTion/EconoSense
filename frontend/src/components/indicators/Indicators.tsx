...
import EconomicCycleGraph from "components/charts/EconomicCycleChart";
  ...
  return (
    <>
      <Box pt={{ base: "130px", md: "80px", xl: "80px" }}>
        <EconomicCycleGraph
          currentStage={
            data[0].prediction.charAt(0).toUpperCase() +
            data[0].prediction.slice(1)
          }
          stage_prob={[
            data[0].peak_prob * 100,
            data[0].contraction_prob * 100,
            data[0].trough_prob * 100,
            data[0].expension_prob * 100,
          ]}
        />
      </Box>
      <SimpleGrid
